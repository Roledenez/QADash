...
class projectManagement_controller extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->data['subview'] = 'admin/user/projectManagement_view';
    ...
    public function createProject() {
        try {
            ...
            if ($this->form_validation->run()) {
                ...
                redirect("admin/projectManagement_controller/LoadProject/$pid");
            }
    ...
    public function LoadProject($pid) {
        ...
        $this->data['subview'] = 'admin/user/testSuit_view';
        $this->load->view("admin/_layout_main", $this->data);
    }
