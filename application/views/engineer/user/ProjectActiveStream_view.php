...
<section class="content-header">
    <h1>
        Dashboard
        <small>Project Active Stream</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">ProjectActiveStream</li>
    </ol>
</section>

<div class="table-responsive mailbox-messages" ng-app="test">
    <table class="table table-hover table-striped" ng-controller="getAllNotificationByProjectCtrl">
        <tbody>
